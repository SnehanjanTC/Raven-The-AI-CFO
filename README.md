...
**Open-Source AI-Powered Financial Operating System**

An executive-grade financial dashboard with autonomous AI agents, real-time analytics, scenario modeling, and multi-provider AI copilot.
...
- **AI Copilot** — Conversational financial advisor with streaming responses. Supports multiple AI providers (Gemini, OpenAI, Anthropic, Grok) — bring your own key.
...
| AI | Google Gemini, OpenAI, Anthropic, xAI Grok |
| Charts | Recharts |
...
- At least one **AI API key** (Gemini recommended for default setup)

### 1. Clone and Install

```bash
git clone https://github.com/your-username/finos.git
cd finos
npm install
```
...
FinOS gracefully degrades without a Supabase connection. Most pages will show fallback/demo data, and the app remains navigable using **Guest Mode** on the login screen. The AI Copilot requires at least one AI API key.
...
FinOS supports four AI providers out of the box. You can switch between them in **Settings > Strategic Intelligence Core**:

| Provider | Model | Notes |
|----------|-------|-------|
| Google Gemini | gemini-1.5-flash | Default. Requires `VITE_GEMINI_API_KEY` |
| OpenAI | gpt-4o | Set key in Settings UI |
| Anthropic | claude-3-5-sonnet | Set key in Settings UI |
| xAI Grok | grok-beta | Set key in Settings UI |
